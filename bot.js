...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__inrlbot_☠☠_[bug] ' +
                                    '\n\n*🥶❣️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
